...
- [alex-popov-tech/store.nvim](https://github.com/alex-popov-tech/store.nvim) - Browse, search, and install from ~5k Neovim plugins (installation supported via `lazy.nvim`).
